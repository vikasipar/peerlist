      ...
      <h1 className='m-5 text-2xl font-semibold'>Contact</h1>
        ...
        <form onSubmit={sendEmail} className='w-[80%] lg:w-[83%] mx-auto text-base lg:text-xl flex-wrap mt-12 md:mt-20'>
            ...
            <div className='flex flex-wrap items-center leading-loose'>
                ...
                <input name='from' id='from' className='outline-none ml-1 w-[9rem] md:w-[27rem] border-b-2 border-[#333333] text-[#00aa45] pl-2' type='text' placeholder='Company*' value='Peerlist' required/>
            </div>
            <div className='flex flex-wrap items-center leading-loose'>
            ...
            <input className='hidden lg:flex w-full outline-none flex-wrap border-b-2 border-[#333333] leading-loose text-[#38aa34]' placeholder='Message*' value='Interested in discussing Frontend Developer opportunity with you.' id='message' name='message' required/>
            <input className='lg:hidden w-full outline-none flex flex-wrap text-base border-b-2 border-[#333333] leading-loose text-[#38aa34]' placeholder='Message*' value='Interested in further discussion.' id='message' name='message' required/><br/>
